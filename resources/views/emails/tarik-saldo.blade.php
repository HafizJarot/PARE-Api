...
Security
Insights
travelme-project/resources/views/send_email/email.blade.php
@HelfanzaNanda
HelfanzaNanda ubah admin
Latest commit 7110348 29 days ago
History
1 contributor
343 lines (306 sloc)  11.4 KB
                                                ...
                                                <td align="left">
                                                    <table border="0" cellpadding="0" cellspacing="0">
                                                        ...
                                                        <tr>
                                                            <td>
                                                                <div class="container">
                                                                    <center><p>Nama Perusahaan : {{ $nama_perusahaan}}</p></center><hr>
                    ...
                    <table border="0" cellpadding="0" cellspacing="0">
                        <tr>
                            <td class="content-block">
                                <span class="apple-link">Pare</span>
                            </td>
                        </tr>
                    </table>
                </div>
