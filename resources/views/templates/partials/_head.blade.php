<head>
    ...
    <link rel="stylesheet" href="{{asset('assets/assets/vendor_components/font-awesome/css/font-awesome.css')}}">
    <link rel="stylesheet" href="{{asset('assets/assets/vendor_components/Ionicons/css/ionicons.css')}}">
    <link rel="stylesheet" href="{{asset('assets/css/master_style.css')}}">
    <link rel="stylesheet" href="{{asset('assets/css/skins/_all-skins.css')}}">
    <link rel="stylesheet" href="{{asset('assets/assets/vendor_components/weather-icons/weather-icons.css')}}">
    <link rel="stylesheet" href="{{asset('assets/assets/vendor_components/jvectormap/jquery-jvectormap.css')}}">
